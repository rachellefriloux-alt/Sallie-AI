    ...
    return (
        <View style={[styles.container, { backgroundColor: colors.background }]}>
                        ...
                        <TouchableOpacity
                            ...
                            style={[
                                styles.archetypeButton,
                                {
                                    ...
                                    borderColor: currentArchetype === archetype ? colors.primary : colors.border.medium,
                                }
                            ]}
                ...
                <ScrollView horizontal showsHorizontalScrollIndicator={false} style={styles.archetypeScroll}>
                    {masteryAreas.map((area, index) => (
                        <View
                            ...
                            style={[
                                styles.masteryCard,
                                { backgroundColor: colors.surface, borderColor: colors.border.medium, shadowColor: colors.primary }
                            ]}
                        >
            ...
            <View style={styles.conversationArea}>
                ...
                {/* Input Area */}
                <View style={[styles.inputArea, { borderTopColor: colors.border.medium }]}>
                    <TextInput
                        style={[
                            styles.textInput,
                            {
