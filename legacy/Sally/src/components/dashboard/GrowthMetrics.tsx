    ...
    <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-6 border border-peacock-200 shadow-lg">
      ...
      <div className="mb-6">
        <div className="flex justify-between items-center mb-2">
          <span className="text-sm font-medium text-gray-400">Overall Learning</span>
      ...
      <div className="space-y-4">
        <h3 className="text-sm font-semibold text-gray-500 mb-3">Recent Growth</h3>
        {growthAreas.map((area, index) => (
          <div key={index} className="space-y-2">
            <div className="flex justify-between items-center">
              <span className="text-sm font-medium text-gray-400">{area.area}</span>
