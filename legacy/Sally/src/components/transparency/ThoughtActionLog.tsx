    ...
    <div className={`thought-action-log bg-gradient-to-br from-sand-50 to-peacock-50 rounded-2xl p-6 ${className}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 border border-peacock-200">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-xl">🔥</span>
            <span className="text-sm font-medium text-gray-400">High Impact</span>
          </div>
        ...
        <div className="bg-white/90 backdrop-blur-sm rounded-xl p-4 border border-peacock-200">
          <div className="flex items-center space-x-2 mb-2">
            <span className="text-xl">⚡</span>
            <span className="text-sm font-medium text-gray-400">Recent Actions</span>
          </div>
          ...
          <div key={thought.id} className="bg-white/90 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <h3 className="font-semibold text-gray-500 capitalize">{thought.type}</h3>
                  <p className="text-sm text-gray-400">{thought.context}</p>
                </div>
              </div>
            ...
            <div className="mb-4">
              <p className="text-gray-500 leading-relaxed">{thought.content}</p>
            </div>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  ...
                  <span className="text-sm font-medium text-gray-500">{thought.confidence}%</span>
                </div>
              </div>
