      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            ...
            {/* Initiatives */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-2">Key Initiatives</h4>
            ...
            {/* Outcomes */}
            <div>
              <h4 className="font-medium text-gray-500 mb-2">Impact Outcomes</h4>
              ...
              {legacyTimeline.map((year, index) => (
                <div key={index} className="flex items-start space-x-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-gray-500">{year.title}</h4>
                    <div className="mb-2">
            ...
            <div className="space-y-3">
              {Object.entries(impactMetrics).map(([category, metrics]) => (
                <div key={category} className="p-3 bg-white rounded-lg border border-peacock-200">
                  <h4 className="font-medium text-gray-500 text-sm capitalize mb-2">{category}</h4>
