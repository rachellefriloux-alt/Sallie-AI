      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-xl font-semibold text-gray-500">{currentProject.name}</h3>
                <p className="text-sm text-gray-400 capitalize">{currentProject.type}</p>
              </div>
            ...
            {/* Features */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-2">Key Features</h4>
            ...
            {/* Milestones */}
            <div>
              <h4 className="font-medium text-gray-500 mb-2">Milestones</h4>
        ...
        <div className="space-y-6">
              ...
              {creativeTools.map((tool) => (
                <div key={tool.id} className="p-3 bg-white rounded-lg border border-peacock-200">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-gray-500 text-sm">{tool.name}</h4>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Creative Blocks</span>
