          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-400 capitalize">{currentPractice.level} level</p>
              </div>
            ...
            {/* Benefits */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Benefits</h4>
            ...
            {/* Techniques */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Techniques</h4>
            ...
            {/* Experiences */}
            <div>
              <h4 className="font-medium text-gray-500 mb-3">Experiences</h4>
              ...
              {spiritualStates.map((state, index) => (
                <div key={index} className="p-3 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg border border-purple-200">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-gray-500">{state.name}</h4>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Divine Connection</span>
                <span className="text-sm font-medium text-blue-700">{transcendenceMetrics.connection}%</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Service to Others</span>
