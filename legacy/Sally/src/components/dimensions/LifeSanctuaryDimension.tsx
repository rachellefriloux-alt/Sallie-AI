        ...
        <div className="lg:col-span-2 space-y-4">
          {familyMembers.map((member) => (
            <div key={member.id} className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
              <div className="flex items-center justify-between mb-4">
                ...
                <div className="flex items-center space-x-3">
                  <div className="text-center">
                    ...
                    <span className="text-xs text-gray-400">{member.energy}%</span>
                  </div>
                  <div className="text-center">
                    <div className="text-lg mb-1">{getMoodEmoji(member.mood)}</div>
                    <span className="text-xs text-gray-400 capitalize">{member.mood}</span>
                  </div>
                </div>
              </div>
              ...
              {/* Needs */}
              <div className="mb-4">
                <h4 className="text-sm font-medium text-gray-500 mb-2">Current Needs</h4>
              ...
              {/* Recent Interactions */}
              <div className="mb-4">
                <h4 className="text-sm font-medium text-gray-500 mb-2">Recent Interactions</h4>
              ...
              {rituals.map((ritual) => (
                <div key={ritual.id} className="p-3 bg-white rounded-lg border border-peacock-200">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-gray-500">{ritual.name}</h4>
                    <div className="flex items-center space-x-2">
                      <span className="text-xs text-gray-400">🔥 {ritual.streak}</span>
                      <span className={`px-2 py-1 rounded-full text-xs ${
                        ritual.impact === 'high' 
