          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-400 capitalize">{currentSystem.phase}</p>
              </div>
            ...
            {/* Capabilities */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Quantum Capabilities</h4>
              <div className="space-y-3">
                {currentSystem.capabilities.map((capability, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-purple-50 rounded-lg border border-purple-200">
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <h5 className="font-medium text-gray-500">{capability.name}</h5>
            ...
            {/* Quantum States */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Quantum States</h4>
              <div className="space-y-2">
                {currentSystem.states.map((state, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-indigo-50 rounded-lg border border-indigo-200">
                    <div className="flex-1">
                      <h5 className="font-medium text-gray-500">{state.name}</h5>
            ...
            {/* Applications */}
            <div>
              <h4 className="font-medium text-gray-500 mb-3">Applications</h4>
            ...
            <div className="space-y-4">
              {quantumExperiments.map((experiment, index) => (
                <div key={index} className="p-4 bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg border border-purple-200">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-gray-500">{experiment.name}</h4>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Overall Core</span>
