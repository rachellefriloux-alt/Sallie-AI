      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            <div className="flex items-center justify-between mb-4">
              <div>
                <h3 className="text-xl font-semibold text-gray-500 flex items-center space-x-2">
                  <span>{currentArea.icon}</span>
                  <span>{currentArea.name}</span>
                </h3>
                <p className="text-sm text-gray-400 capitalize">{currentArea.phase}</p>
              </div>
            ...
            {/* Metrics */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Performance Metrics</h4>
                ...
                {Object.entries(currentArea.metrics).map(([key, value]) => (
                  <div key={key} className="p-3 bg-blue-50 rounded-lg border border-blue-200">
                    <div className="flex items-center justify-between mb-1">
                      <h5 className="font-medium text-gray-500 text-sm capitalize">
            ...
            {/* Systems */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Management Systems</h4>
                ...
                {currentArea.systems.map((system, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-cyan-50 rounded-lg border border-cyan-200">
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-1">
                        <h5 className="font-medium text-gray-500">{system.name}</h5>
                        <span className="text-sm font-bold text-cyan-700">{system.effectiveness}%</span>
                      </div>
                      <p className="text-xs text-gray-400 mb-1">{system.description}</p>
            ...
            {/* Practices */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Daily Practices</h4>
            ...
            {/* Challenges */}
            <div>
              <h4 className="font-medium text-gray-500 mb-3">Current Challenges</h4>
              ...
              {dailySchedule.map((block, index) => (
                <div key={index} className="flex items-center justify-between p-3 bg-gradient-to-r from-blue-50 to-cyan-50 rounded-lg border border-blue-200">
                  <div className="flex items-center space-x-4">
                    ...
                    <span className="text-sm font-medium text-gray-500 w-32">{block.activity}</span>
                  </div>
                  <div className="flex items-center space-x-4">
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Focus Achievement</span>
                <span className="text-sm font-medium text-blue-700">{timeEnergyMetrics.focusAchievement}%</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Rhythm Harmony</span>
