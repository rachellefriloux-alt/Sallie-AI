          ...
          {activeMode === 'voice' && (
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-peacock-200 mb-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400 mb-4">Natural voice communication with Sallie</p>
                ...
                {voiceTranscript && (
                  <div className="mt-4 p-3 bg-gray-50 rounded-lg">
                    ...
                    <p className="text-gray-500">{voiceTranscript}</p>
                  </div>
                )}
              </div>
            </div>
          ...
          {activeMode === 'telepathic' && (
            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 border border-peacock-200 mb-6">
              <div className="text-center">
                ...
                <p className="text-sm text-gray-400 mb-4">Direct mind-to-mind communication</p>
