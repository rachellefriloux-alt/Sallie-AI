      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            ...
            {/* Skills Development */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Skills Development</h4>
              <div className="space-y-3">
                {currentArea.skills.map((skill, index) => (
                  <div key={index} className="flex items-center justify-between p-3 bg-green-50 rounded-lg border border-green-200">
                    <div className="flex-1">
                      <div className="flex items-center justify-between mb-2">
                        <h5 className="font-medium text-gray-500">{skill.name}</h5>
                      ...
                      <p className="text-xs text-gray-400 mt-1">Next: {skill.next}</p>
                    </div>
                  </div>
                ))}
              </div>
            ...
            {/* Milestones */}
            <div className="mb-4">
              <h4 className="font-medium text-gray-500 mb-3">Growth Milestones</h4>
                ...
                {currentArea.milestones.map((milestone, index) => (
                  <div key={index} className="flex items-center justify-between p-2 bg-gray-50 rounded-lg">
                    <div className="flex items-center space-x-3">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-500">{milestone.title}</p>
            ...
            <div className="space-y-3">
              {growthPractices.map((practice, index) => (
                <div key={index} className="p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-lg border border-green-200">
                  <div className="flex items-center justify-between mb-2">
                    <h4 className="font-medium text-gray-500">{practice.name}</h4>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl p-6 border border-peacock-200">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Breakthroughs</span>
                <span className="text-sm font-medium text-green-700">{growthMetrics.breakthroughs}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Current Challenges</span>
                <span className="text-sm font-medium text-yellow-600">{growthMetrics.challenges}</span>
              </div>
              <div className="flex items-center justify-between">
                <span className="text-sm text-gray-400">Recent Insights</span>
