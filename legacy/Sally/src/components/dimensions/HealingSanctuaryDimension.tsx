  ...
  return (
    <div className="p-6 bg-gradient-to-br from-blue-50 to-purple-50 min-h-screen">
      ...
      >
        ...
        <p className="text-gray-400">Your comprehensive mental health and wellness dashboard</p>
      </motion.div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500">{mentalHealthMetrics.bipolar.stability}%</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500">{mentalHealthMetrics.adhd.focus}%</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-400">Hyperfocus</span>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500">{mentalHealthMetrics.adhd.productivity}%</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500">{mentalHealthMetrics.ptsd.stability}%</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm text-gray-500">{mentalHealthMetrics.ptsd.progress}%</span>
                  </div>
                </div>
                <div className="flex items-center justify-between">
                  <span className="text-gray-400">Nightmares</span>
                  <span className={`px-3 py-1 rounded-full text-sm font-medium ${
        ...
        >
          ...
          <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100">
            ...
            <div className="space-y-3">
              ...
              <button className="w-full px-4 py-3 bg-gray-200 text-gray-500 rounded-lg hover:bg-gray-300 transition-colors">
