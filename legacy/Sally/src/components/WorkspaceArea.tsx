...
export function WorkspaceArea({ activeSection, className }: WorkspaceAreaProps) {
  ...
  const renderWorkspace = () => {
    switch (activeSection) {
      ...
      case 'genesis':
        return <div className="p-6"><p className="text-gray-400">Genesis Panel coming soon...</p></div>;
      case 'heritage':
        return <div className="p-6"><p className="text-gray-400">Heritage Panel coming soon...</p></div>;
      case 'mood':
        return <div className="p-6"><p className="text-gray-400">Mood Panel coming soon...</p></div>;
      case 'human-level':
        return <HumanLevelExpansion />;
      case 'social':
        return <div className="p-6"><p className="text-gray-400">Social Panel coming soon...</p></div>;
      case 'settings':
        return <div className="p-6"><p className="text-gray-400">Settings Panel coming soon...</p></div>;
      default:
        return <ChatArea messages={mockMessages} onSend={handleSend} isConnected={true} />;
    }
  };
