...
type ApiResponse<T = any> = { data?: T; success: boolean; message?: string; error?: string };
type ConnectionState = 'connected' | 'connecting' | 'disconnected' | 'error';
type NeuralAnalytics = { accuracy: number; latency: number; patterns: number };
type SystemFeed = { id: string; message: string; timestamp: string; type: string };
