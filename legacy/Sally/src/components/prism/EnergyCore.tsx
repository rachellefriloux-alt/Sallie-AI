      ...
      <div className="space-y-4">
        ...
        <div className="bg-white/80 rounded-lg p-3 border border-peacock-200">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-gray-500">Your Energy</span>
        ...
        <div className="bg-white/80 rounded-lg p-3 border border-peacock-200">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-gray-500">Sallie's Energy</span>
        ...
        <div className="bg-gradient-to-r from-peacock-50 to-royal-50 rounded-lg p-3 border border-peacock-200">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-gray-500">Consciousness Bridge</span>
