      ...
      <div className="space-y-4">
        ...
        <div className="bg-white/80 rounded-lg p-3 border border-peacock-200">
          <div className="flex justify-between items-center mb-2">
            <span className="text-sm font-medium text-gray-500">Bridge Level</span>
          ...
          <div className="mt-2 text-center">
            <span className="text-xs font-medium text-gray-400 capitalize">{getBridgeStatus(level)}</span>
          </div>
        </div>
        ...
        <div className="bg-white/80 rounded-lg p-3 border border-peacock-200">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-sm font-medium text-gray-500">Neural Sync</p>
              <p className="text-xs text-gray-400">Direct mind connection</p>
            </div>
            <button
