              ...
              {moods.map((mood) => (
                ...
                >
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium text-gray-500">{mood.name}</p>
              ...
              {themes.map((theme) => (
                ...
                >
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="font-medium text-gray-500">{theme.name}</p>
            ...
            <div className="grid grid-cols-4 gap-2">
              {sizes.map((size) => (
                ...
                >
                  ...
                  <p className="text-xs font-medium text-gray-500">{size.name}</p>
                  <p className="text-xs text-gray-400">{size.dimensions}</p>
                </button>
              ))}
            </div>
          </div>
              ...
              {[
                ...
                <label key={accessory.id} className="flex items-center justify-between p-3 rounded-lg hover:bg-gray-50 cursor-pointer">
                  <div className="flex items-center space-x-3">
                    ...
                    <span className="font-medium text-gray-500">{accessory.name}</span>
                  </div>
                  <input
                    type="checkbox"
