        ...
        <div className="flex items-center justify-between text-sm">
          <div className="flex items-center space-x-4">
            <span className="flex items-center space-x-1">
              ...
              <span className="text-gray-400">Sallie is active and present</span>
            </span>
            <span className="text-gray-400">•</span>
            <span className="text-gray-400">Mood: {sallieMood}</span>
          </div>
          
          <div className="flex items-center space-x-4">
            <button 
              onClick={() => setSallieMood('happy')}
              className="text-gray-400 hover:text-peacock-600 transition-colors"
            >
              Make Sallie happy 😊
            </button>
            <span className="text-gray-400">•</span>
