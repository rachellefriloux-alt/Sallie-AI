...
/** Descriptions for Sovereign Modes */
export const SOVEREIGN_MODE_DESCRIPTIONS: Record<SovereignModeKey, string> = {
  CEO: 'Business strategist and productivity expert',
  ESQ: 'Legal advisor and analytical thinker',
  MATRIARCH: 'Family and household management expert',
  HEALER: 'Emotional support and wellness guide',
  CREATIVE: 'Creative director and design strategist',
  ORACLE: 'General purpose AI assistant',
};
