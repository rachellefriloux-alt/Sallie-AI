...
export function MotionAIInterface({ navigation }: any) {
    ...
    try {
      ...
      const newPattern: MotionPattern = {
        ...
        keyframes: [
          ...
          { frame: 30, position: { x: 100, y: 50, z: 25 } },
          { frame: 60, position: { x: 200, y: 0, z: 0 } }
        ],
    ...
    <ScrollView style={styles.tabContent}>
      ...
      <View style={styles.section}>
        ...
        {analyses.map((analysis, index) => (
          <View key={analysis.pattern_id} style={styles.analysisCard}>
        ...
        {motionData.map((pattern, index) => (
          <View key={pattern.id} style={styles.patternCard}>
            ...
            <Text style={styles.patternKeyframes}>
              Keyframes: {pattern.keyframes.length}
            </Text>
          </View>
        ))}
      </View>
    ...
    <ScrollView style={styles.tabContent}>
      <View style={styles.section}>
        ...
        <Text style={styles.patternDescription}>
          Browse and manage motion patterns for various activities including dance, sports, and gestures.
        </Text>
          ...
          {['Dance', 'Sports', 'Gestures', 'Expressions', 'Locomotion'].map((type) => (
            <TouchableOpacity key={type} style={styles.patternTypeCard}>
              ...
              <Text style={styles.patternTypeDescription}>
                {type.toLowerCase()} motion patterns and analysis
              </Text>
            </TouchableOpacity>
          ))}
        </View>
